	...
	, mSelectBtn(nullptr)
{
	...
	SetSprite(CResMgr::GetI()->LoadSprite(L"UI_Panel_1", L"texture\\ui\\panel_1.bmp"));
	...
	mSelectBtn->SetSprite(CResMgr::GetI()->LoadTexture(L"UI_Btn_1", L"texture\\ui\\button_1.bmp"));
