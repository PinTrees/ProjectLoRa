...
void Scene_Main::Enter()
{
	...
	pPanelUI->SetTexture(CResMgr::GetI()->LoadTexture(L"UI_panel_1", L"texture\\ui\\panel_1.bmp"));
...
void Scene_Main::OpenItemDataUI()
{
	...
	((CPanelUI*)pPanelUI)->SetFixedPos(true);
